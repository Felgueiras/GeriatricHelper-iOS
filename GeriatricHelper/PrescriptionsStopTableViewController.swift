...
// show stopp criteria from CGA
class PrescriptionsStopTableViewController: UITableViewController {
...
//    let SegueViewScaleSegue = "ViewScaleCGAGuide"
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return Constants.stoppCriteria.count
    }
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ItemCell", for: indexPath)
        
        let criteria = Constants.stoppCriteria[indexPath.row]
